...
//{
//    Task<IEnumerable<T>> GetAsync(string? filter = null, string? orderBy = null, int? top = null, int? skip = null);
...
//    public async Task<IEnumerable<T>> GetAsync<T>(string entitySetName, string? filter = null, string? orderBy = null, int? top = null, int? skip = null)
//    {
//        try
//        {
...
//    public async Task<T?> GetOrderByIdAsync<T>(Guid id)
//    {
//        try
//        {
